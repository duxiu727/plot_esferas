...
cmap_yellow = make_cmap([(248, 255, 0), (187, 180, 120), (184, 146, 14)],
                        position=[0, 0.9, 1], bit=True)
...
def plot_esfera(ax, x, y, **kwargs):
  ...
  if alpha < 0.9:
    ...
    alpha_l = alpha
  line, = ax.plot(x, y, "o", mfc=color, mec=color, markersize=.5 *
                  markersize, label=label, alpha=alpha_l)
